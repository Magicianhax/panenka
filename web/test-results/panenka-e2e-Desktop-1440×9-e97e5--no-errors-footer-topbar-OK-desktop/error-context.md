...
- Name: panenka-e2e.spec.ts >> Desktop (1440×900) >> /profile — loads, no errors, footer/topbar OK
- Location: tests\panenka-e2e.spec.ts:87:9

# Error details

```
Error: Footer missing required elements on /profile
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    - generic [ref=e3]:
      ...
      - generic [ref=e27]:
        - generic [ref=e28]: ◆ your locker
        - generic [ref=e29]: PROFILE.
      - generic [ref=e31]:
        - generic [ref=e32]: CONNECT WALLET ↑
        - generic [ref=e33]: to see your matches and claim winnings
    - contentinfo [ref=e34]:
      - generic [ref=e35]:
        - generic [ref=e36]:
          - generic [ref=e37]:
            - link "PANENKA" [ref=e38] [cursor=pointer]:
              - /url: /
              - img "PANENKA" [ref=e39]
            - paragraph [ref=e40]: 1v1 on-chain penalty shootouts. Read your rival, stake OKB, winner takes the pot.
            - link "contract 0x51F6…5110 ↗" [ref=e41] [cursor=pointer]:
              - /url: https://www.oklink.com/xlayer/address/0x51F6DbeFCeE8ad9B491f08615211E09027f45110
              - generic [ref=e42]: contract
              - text: 0x51F6…5110 ↗
          - generic [ref=e43]:
            - generic [ref=e44]: Play
            - link "Lobby" [ref=e45] [cursor=pointer]:
              - /url: /lobby
            - link "Create a Match" [ref=e46] [cursor=pointer]:
              - /url: /create
            - link "Leaderboard" [ref=e47] [cursor=pointer]:
              - /url: /leaderboard
            - link "Profile" [ref=e48] [cursor=pointer]:
              - /url: /profile
          - generic [ref=e49]:
            - generic [ref=e50]: Learn
            - link "How to Play" [ref=e51] [cursor=pointer]:
              - /url: /faq
            - link "About" [ref=e52] [cursor=pointer]:
              - /url: /about
          - generic [ref=e53]:
            - generic [ref=e54]: Connect
            - link "@play_panenka ↗" [ref=e55] [cursor=pointer]:
              - /url: https://x.com/play_panenka
            - link "GitHub ↗" [ref=e56] [cursor=pointer]:
              - /url: https://github.com/Magicianhax/panenka
            - link "X Layer ↗" [ref=e57] [cursor=pointer]:
              - /url: https://www.okx.com/xlayer
        - generic [ref=e58]:
          - generic [ref=e59]: © 2026 PANENKA · built on X Layer
          - generic [ref=e60]: not affiliated with FIFA or any football association
  - alert [ref=e61]
```
