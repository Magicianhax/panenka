...
- Name: panenka-e2e.spec.ts >> Desktop (1440×900) >> /about — loads, no errors, footer/topbar OK
- Location: tests\panenka-e2e.spec.ts:87:9

# Error details

```
Error: Footer missing required elements on /about
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      ...
      - generic [ref=e27]:
        ...
        - generic [ref=e29]: PANENKA.
        - paragraph [ref=e30]: A 1v1 on-chain penalty shootout. Stake OKB, pick a nation, and read your opponent for five rounds. It's rock-paper-scissors with real stakes — pure nerve and mind games. Winner takes the pot.
      - generic [ref=e31]:
        - generic [ref=e32]:
          - generic [ref=e33]: The name
          - paragraph [ref=e34]:
            - text: A
            - emphasis [ref=e35]: Panenka
            - text: is the cheekiest penalty in football — you don't out-power the keeper, you
            - strong [ref=e36]: out-think
            - text: "him. That's the whole game here: every round is a duel of reads and bluffs."
        - generic [ref=e37]:
          - generic [ref=e38]: Provably fair
          - paragraph [ref=e39]:
            - text: Each round both players
            - strong [ref=e40]: commit
            - text: a hashed move, then
            - strong [ref=e41]: reveal
            - text: it. Nobody — not even us — can see your pick before it's locked. The contract resolves every goal on-chain.
        - generic [ref=e42]:
          - generic [ref=e43]: Winner takes the pot
          - paragraph [ref=e44]:
            - text: Both stakes form the pot. The winner takes
            - strong [ref=e45]: 97.5%
            - text: ; a flat 2.5% fee keeps the lights on. A draw refunds both players in full.
        - generic [ref=e46]:
          - generic [ref=e47]: Fully on X Layer
          - paragraph [ref=e48]:
            - text: Stakes are escrowed by the smart contract and paid out trustlessly. No house, no custody — just two players and the chain. Built for the
            - strong [ref=e49]: X Cup
            - text: · World Cup 2026 season.
      - generic [ref=e51]:
        - generic [ref=e52]: ◆ on-chain
        - generic [ref=e53]:
          - generic [ref=e54]: Network
          - generic [ref=e55]: X Layer mainnet · chainId 196
        - generic [ref=e56]:
          - generic [ref=e57]: Token
          - generic [ref=e58]: OKB (native)
        - generic [ref=e59]:
          - generic [ref=e60]: Contract
          - link "0x51F6…5110 ↗" [ref=e61] [cursor=pointer]:
            - /url: https://www.oklink.com/xlayer/address/0x51F6DbeFCeE8ad9B491f08615211E09027f45110
        - generic [ref=e62]:
          - generic [ref=e63]: Fee
          - generic [ref=e64]: 2.5% of the pot
        - generic [ref=e65]:
          - link "how to play →" [ref=e66] [cursor=pointer]:
            - /url: /faq
          - link "deploy a challenge →" [ref=e67] [cursor=pointer]:
            - /url: /create
    - contentinfo [ref=e68]:
      - generic [ref=e69]:
        - generic [ref=e70]:
          - generic [ref=e71]:
            - link "PANENKA" [ref=e72] [cursor=pointer]:
              - /url: /
              - img "PANENKA" [ref=e73]
            - paragraph [ref=e74]: 1v1 on-chain penalty shootouts. Read your rival, stake OKB, winner takes the pot.
            - link "contract 0x51F6…5110 ↗" [ref=e75] [cursor=pointer]:
              - /url: https://www.oklink.com/xlayer/address/0x51F6DbeFCeE8ad9B491f08615211E09027f45110
              - generic [ref=e76]: contract
              - text: 0x51F6…5110 ↗
          - generic [ref=e77]:
            - generic [ref=e78]: Play
            - link "Lobby" [ref=e79] [cursor=pointer]:
              - /url: /lobby
            - link "Create a Match" [ref=e80] [cursor=pointer]:
              - /url: /create
            ...
            - link "Profile" [ref=e82] [cursor=pointer]:
              - /url: /profile
          - generic [ref=e83]:
            - generic [ref=e84]: Learn
            - link "How to Play" [ref=e85] [cursor=pointer]:
              - /url: /faq
            - link "About" [ref=e86] [cursor=pointer]:
              - /url: /about
          - generic [ref=e87]:
            - generic [ref=e88]: Connect
            - link "@play_panenka ↗" [ref=e89] [cursor=pointer]:
              - /url: https://x.com/play_panenka
            - link "GitHub ↗" [ref=e90] [cursor=pointer]:
              - /url: https://github.com/Magicianhax/panenka
            - link "X Layer ↗" [ref=e91] [cursor=pointer]:
              - /url: https://www.okx.com/xlayer
        - generic [ref=e92]:
          - generic [ref=e93]: © 2026 PANENKA · built on X Layer
          - generic [ref=e94]: not affiliated with FIFA or any football association
  - alert [ref=e95]
```
